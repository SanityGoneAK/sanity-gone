const PotentialSixIcon: React.FC<React.HTMLAttributes<SVGElement>> = (
	...
	return (
		<svg
			...
			{...props}
		>
			<g clipPath="url(#clip0_2515:6241)">
				<path
					d="M255.212 149.505H67.6304L105.63 173.872H293.212L255.212 149.505Z"
					fill="#E8E8F2"
				/>
				<path
					d="M157.352 235.771L99.3858 57.3702L87.9538 101.04L145.92 279.441L157.352 235.771Z"
					fill="#E8E8F2"
				/>
				<path
					d="M45.0653 169.359L196.822 59.1013L151.757 61.7236L0 171.982L45.0653 169.359Z"
					fill="#E8E8F2"
				/>
				<path
					d="M73.5276 42.0493L225.285 152.307L208.865 110.258L57.1077 0L73.5276 42.0493Z"
					fill="#E8E8F2"
				/>
				<path
					d="M203.405 29.7775L145.439 208.179L180.357 179.568L238.323 1.16725L203.405 29.7775Z"
					fill="#E8E8F2"
				/>
				<path
...
export default PotentialSixIcon;
