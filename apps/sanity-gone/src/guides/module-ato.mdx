...
| ![HarukaModY](https://arknights.wiki.gg/images/The_Belated_Memorial.png?5d2a4c) | ![PepeModA](https://arknights.wiki.gg/images/Pepe%27s_Specialized_Badge.png?b79e53) | ![NymphModX](https://arknights.wiki.gg/images/%22Aspiration%22.png?402b80)|
| --- | --- | --- |
...
<ModuleRecommendation moduleType="X" charId="char_1040_blaze2" recommended={true} recommendedLevel={3} client:load/>
...
<ModuleRecommendation moduleType="Y" charId="char_4202_haruka" recommended={true} recommendedLevel={1} client:load/>
